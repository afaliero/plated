...
import {
  ...
  noPreferenceAiCalls,
  topKRecall,
} from "src/services/recipe/preference-evals.js";

test("preference evals measure candidate safety and top-k relevance", () => {
...
test("no-preference eval requires zero AI calls", () => {
